...
export declare const AVERAGING_WINDOWS: AveragingWindow[];
...
export declare const DEFAULT_LDF_SELECTION: LdfSelectionOptions;
...
export declare const DEFAULT_TREND_FIT: TrendFitOptions;
